...
variable "vmss" { default = [] }
variable "avset_id" { default = {} }
variable "nics" {default = [[]]}
variable "lb_backend_pool" { default = {} }
variable "lb_set_id" { default = [[]] }
variable "vmss_subnet_set" { default = [] }
variable "set_id" { default = [] }
variable "vmss_id" { default = {} }
